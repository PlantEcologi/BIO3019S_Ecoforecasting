...
The slideshow below covers this section and the next (Data Management) in one, since they are both key components of Firecast Infrastructure. [Click this link](presentations/3_reproducibility.html){target="_blank"} to view in full screen.
