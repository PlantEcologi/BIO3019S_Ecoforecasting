...
> - Note that these are both focused on managing the number of flower heads (often referred to as "cones"), which represents _fecundity_
...
```{r, echo=FALSE, fig.cap = "*Intraspecific variation in sensitivity* to harvesting for four different species. Pink dots highlight where the change in population-level extinction probability under 0% versus 50% harvesting is greater than 0.1 [@Treurnicht2021]. White = species-specific occurrence records; Black = distribution of all Proteaceae in the CFR.", fig.width=3, out.width="90%"}
