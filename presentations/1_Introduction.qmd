...
## Our hypothetical example {.smaller background-color="#c2c190"}
...
-   *"Does X have an effect on Y?"*
    - Null hypothesis testing is aimed at testing the "null" hypothesis of no relationship. Rejecting the null hypothesis (p < 0.05) simply means there is a relationship, but doesn't specify what it is!
...
This figure from Dietze et al. 2018 provides an expanded representation of the conceptual links between iterative ecological forecasting, the scientific method, decision making (here in the context of *adaptive management*, which is a management paradigm that focuses on learning by doing), and adaptive monitoring.
...
Adding reproducible research to the 4 learning cycles represented in the Dietze figure highlights what I like to think of as *"The Olympian Challenge of data-driven ecological decision making"*.

We will touch on these different aspects throughout this module.
